...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_b,		spawn,		{.v = (const char*[]){ "addbookmark", NULL } } },
	...
	{ MODKEY|ShiftMask, 		XK_Tab,	 	spawn, 		SHCMD("toggle-layout") },
  { MODKEY, XK_Home, spawn, SHCMD("home-monitor-layout") },
